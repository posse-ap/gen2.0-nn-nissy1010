...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $languages = StudyRecord::leftJoin('study_languages', 'study_data.study_language_id', '=', 'study_languages.id')
        ...
        $test1 = StudyRecord::with('study_languages')->get()->groupBy('study_date');

        // 円グラフ（内容）
        $contents = StudyRecord::leftJoin('study_contents', 'study_data.study_content_id', '=', 'study_contents.id')
        ...
        $test2 = StudyRecord::with('study_contents')->get()->groupBy('study_date');
