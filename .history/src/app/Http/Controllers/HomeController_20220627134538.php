...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $test1 = StudyRecord::leftJoin('study_languages', 'study_records.study_language_id', '=', 'study_languages.id')
        ...
        // 円グラフ（内容）
        $test2contents = StudyRecord::leftJoin('study_contents', 'study_records.study_content_id', '=', 'study_contents.id')
        ...
        $ = StudyContent::with('records')->get()->groupBy('study_date')->first();
