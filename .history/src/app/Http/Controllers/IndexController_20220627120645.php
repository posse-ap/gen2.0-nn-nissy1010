...
class IndexController extends Controller
{
    public function index()
    {
        ...
        $data = [
            ...
            'contents' => $contents,
            'bars' => $bars,
            'test_languages' => $check_languages,
            'test_contents' => $check_contents,
            'test_bars' => $check_bars
        ];
