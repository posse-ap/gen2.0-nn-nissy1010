...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $test1 = StudyLanguage::with('languages')->get();

        // 円グラフ（内容）
        $contents = Studycord::leftJoin('study_contents', 'study_records.study_content_id', '=', 'study_contents.id')
        ...
        $test2 = StudyRecord::with('contents')->get();
